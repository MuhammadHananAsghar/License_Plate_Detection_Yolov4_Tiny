...
save_path = '/home/zerosec/Downloads/Model_Files/yolov4_tiny/'
full_path_to_images = '/home/zerosec/Downloads/Model_Files/yolov4_tiny/dataset/images/'
...
with open(f'{save_path}train.txt', 'w') as train_txt:
...
with open(f'{save_path}test.txt', 'w') as test_txt:
    # Going through all elements of the list
    for e in p_test:
        # Writing current path at the end of the file
        test_txt.write(e)
